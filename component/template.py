...
register_template(
    template_name='llama3-base-alpaca',
    system_format='<|begin_of_text|>{content}\n\n',
    user_format='### Instruction:\n{content}\n\n### Response:\n',
    assistant_format='{content}<|end_of_text|>',
    system="Below is an instruction that describes a task. Write a response that appropriately completes the request.",
...
register_template(
    template_name='gemma-base-alpaca',
...
register_template(
    template_name='yi-base-alpaca',
    system_format='<|startoftext|>{content}\n\n',
    user_format='### Instruction:\n{content}\n\n### Response:\n',
    assistant_format='{content}<|endoftext|>\n',
    system='Below is an instruction that describes a task. Write a response that appropriately completes the request.',
    stop_word='<|endoftext|>',
