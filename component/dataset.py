...
class IntuitionSFTDataset(Dataset):
    """
    统一的数据处理dataset
    """
    ...
    def __getitem__(self, index):
        ...
        human = data['human'].strip()
        assistant = f"the correct answer is {data['assistant'].strip()}"
...
class JsonSFTDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        human = data['instruction'].strip()
        assistant = data['output'].strip()
...
class PandaSFTDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        human = data['human'].strip()
        assistant = data['assistant'].strip()
